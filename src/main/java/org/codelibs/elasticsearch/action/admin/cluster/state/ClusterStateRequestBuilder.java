...
package org.codelibs.elasticsearch.action.admin.cluster.state;

import org.codelibs.elasticsearch.action.support.IndicesOptions;
import org.codelibs.elasticsearch.action.support.master.MasterNodeReadOperationRequestBuilder;
...
public class ClusterStateRequestBuilder extends MasterNodeReadOperationRequestBuilder<ClusterStateRequest, ClusterStateResponse, ClusterStateRequestBuilder> {
    ...
    /**
     * Should the cluster state result include the {@link org.codelibs.elasticsearch.cluster.metadata.MetaData}. Defaults
     * to <tt>true</tt>.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.codelibs.elasticsearch.cluster.node.DiscoveryNodes}. Defaults
     * to <tt>true</tt>.
     */
    ...
    /**
     * Should the cluster state result include teh {@link org.codelibs.elasticsearch.cluster.routing.RoutingTable}. Defaults
     * to <tt>true</tt>.
     */
    ...
    /**
     * When {@link #setMetaData(boolean)} is set, which indices to return the {@link org.codelibs.elasticsearch.cluster.metadata.IndexMetaData}
