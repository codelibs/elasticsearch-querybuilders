...
package org.codelibs.elasticsearch.action.admin.cluster.stats;
...
import org.codelibs.elasticsearch.plugins.PluginInfo;
...
public class ClusterStatsNodes implements ToXContent {
    ...
    public static class OsStats implements ToXContent {
        ...
        final org.codelibs.elasticsearch.monitor.os.OsStats.Mem mem;
        ...
        private OsStats(List<NodeInfo> nodeInfos, List<NodeStats> nodeStatsList) {
            ...
            this.mem = new org.codelibs.elasticsearch.monitor.os.OsStats.Mem(totalMemory, freeMemory);
        }
        ...
        public org.codelibs.elasticsearch.monitor.os.OsStats.Mem getMem() {
            return mem;
        }
    ...
    public static class JvmStats implements ToXContent {
        ...
        private JvmStats(List<NodeInfo> nodeInfos, List<NodeStats> nodeStatsList) {
            ...
            for (NodeStats nodeStats : nodeStatsList) {
                org.codelibs.elasticsearch.monitor.jvm.JvmStats js = nodeStats.getJvm();
                if (js == null) {
                    continue;
                }
