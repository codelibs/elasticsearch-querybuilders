...
public class BulkProcessor implements Closeable {
    ...
    public static class Builder {
         ...
         * <p>
         * Note, both {@link #setBulkActions(int)} and {@link #setBulkSize(org.codelibs.elasticsearch.common.unit.ByteSizeValue)}
         ...
         *
         * @see org.codelibs.elasticsearch.action.bulk.BackoffPolicy#exponentialBackoff()
         */
