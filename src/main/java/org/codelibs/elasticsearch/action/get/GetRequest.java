...
import org.codelibs.elasticsearch.action.RealtimeRequest;
import org.codelibs.elasticsearch.action.ValidateActions;
import org.codelibs.elasticsearch.action.support.single.shard.SingleShardRequest;
 ...
 * {@link org.codelibs.elasticsearch.client.Requests#getRequest(String)}.
 * <p>
 * The operation requires the {@link #index()}, {@link #type(String)} and {@link #id(String)}
 * to be set.
 *
 * @see org.codelibs.elasticsearch.action.get.GetResponse
 * @see org.codelibs.elasticsearch.client.Requests#getRequest(String)
 * @see org.codelibs.elasticsearch.client.Client#get(GetRequest)
 */
public class GetRequest extends SingleShardRequest<GetRequest> implements RealtimeRequest {
    ...
    /**
     * Sets the versioning type. Defaults to {@link org.codelibs.elasticsearch.index.VersionType#INTERNAL}.
     */
