...
package org.codelibs.elasticsearch.action.index;
...
import org.codelibs.elasticsearch.action.DocumentRequest;
import org.codelibs.elasticsearch.action.RoutingMissingException;
import org.codelibs.elasticsearch.action.TimestampParsingException;
import org.codelibs.elasticsearch.action.support.replication.ReplicatedWriteRequest;
 ...
 * created using {@link org.codelibs.elasticsearch.client.Requests#indexRequest(String)}.
 *
 ...
 * its string form ({@link #source(String)}) or using a {@link org.codelibs.elasticsearch.common.xcontent.XContentBuilder}
 * ({@link #source(org.codelibs.elasticsearch.common.xcontent.XContentBuilder)}).
 *
 * If the {@link #id(String)} is not set, it will be automatically generated.
 *
 * @see IndexResponse
 * @see org.codelibs.elasticsearch.client.Requests#indexRequest(String)
 * @see org.codelibs.elasticsearch.client.Client#index(IndexRequest)
 */
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocumentRequest<IndexRequest> {
    ...
    /**
     * Index the Map as a {@link org.codelibs.elasticsearch.client.Requests#INDEX_CONTENT_TYPE}.
     *
     ...
     *
     * Note, its preferable to either set it using {@link #source(org.codelibs.elasticsearch.common.xcontent.XContentBuilder)}
    ...
    /**
     * Sets a string representation of the {@link #opType(org.codelibs.elasticsearch.action.index.IndexRequest.OpType)}. Can
