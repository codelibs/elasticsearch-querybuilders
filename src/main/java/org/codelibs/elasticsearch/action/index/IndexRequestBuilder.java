...
import org.codelibs.elasticsearch.action.support.WriteRequestBuilder;
import org.codelibs.elasticsearch.action.support.replication.ReplicationRequestBuilder;
...
public class IndexRequestBuilder extends ReplicationRequestBuilder<IndexRequest, IndexResponse, IndexRequestBuilder>
     ...
     * <p>
     * Note, its preferable to either set it using {@link #setSource(org.codelibs.elasticsearch.common.xcontent.XContentBuilder)}
    ...
    /**
     * Set to <tt>true</tt> to force this index to use {@link org.codelibs.elasticsearch.action.index.IndexRequest.OpType#CREATE}.
     */
