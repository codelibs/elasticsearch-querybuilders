...
public class SearchRequestBuilder extends ActionRequestBuilder<SearchRequest, SearchResponse, SearchRequestBuilder> {
    ...
    /**
     * The search type to execute, defaults to {@link org.codelibs.elasticsearch.action.search.SearchType#DEFAULT}.
     */
     ...
     *
     * @see org.codelibs.elasticsearch.index.query.QueryBuilders
     */
    ...
    /**
     * Should each {@link org.codelibs.elasticsearch.search.SearchHit} be returned with an
    ...
    /**
     * Should each {@link org.codelibs.elasticsearch.search.SearchHit} be returned with its
     * version.
     */
     ...
     *
     * @see org.codelibs.elasticsearch.search.sort.SortBuilders
     */
     ...
     * {@link #addRescorer(org.codelibs.elasticsearch.search.rescore.RescoreBuilder, int)}.
     *
