...
import static org.codelibs.elasticsearch.action.search.ShardSearchFailure.readShardSearchFailure;
import static org.codelibs.elasticsearch.search.internal.InternalSearchResponse.readInternalSearchResponse;
...
public class SearchResponse extends ActionResponse implements StatusToXContent {
    ...
    /**
     * If scrolling was enabled ({@link SearchRequest#scroll(org.codelibs.elasticsearch.search.Scroll)}, the
