 ...
 * simply returns an {@link org.codelibs.elasticsearch.action.ActionFuture}, while the second accepts an
 * {@link org.codelibs.elasticsearch.action.ActionListener}.
 * <p>
 * A client can either be retrieved from a {@link org.codelibs.elasticsearch.node.Node} started, or connected remotely
 * to one or more nodes using {@link org.codelibs.elasticsearch.client.transport.TransportClient}.
 *
 * @see org.codelibs.elasticsearch.node.Node#client()
 * @see org.codelibs.elasticsearch.client.transport.TransportClient
 */
public interface Client extends ElasticsearchClient, Releasable {
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#bulkRequest()
     */
