...
public interface ClusterAdminClient extends ElasticsearchClient {
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#nodesInfoRequest(String...)
     */
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#clusterStatsRequest
     */
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#nodesStatsRequest(String...)
     */
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#listTasksRequest()
     */
     ...
     * @return the result future
     * @see org.codelibs.elasticsearch.client.Requests#getTaskRequest()
     */
     ...
     * @param request The nodes tasks request
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#cancelTasksRequest()
     */
