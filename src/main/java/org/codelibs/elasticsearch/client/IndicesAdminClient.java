...
public interface IndicesAdminClient extends ElasticsearchClient {
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#deleteIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#closeIndexRequest(String)
     */
     ...
     * @param request The close index request
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#openIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.codelibs.elasticsearch.client.Requests#refreshRequest(String...)
     */
     ...
     * @see org.codelibs.elasticsearch.client.Requests#flushRequest(String...)
     */
     ...
     * @return A result future
     * @see org.codelibs.elasticsearch.client.Requests#syncedFlushRequest(String...)
     */
     ...
     * @return A result future
     * @see org.codelibs.elasticsearch.client.Requests#forceMergeRequest(String...)
     */
     ...
     * @return A result future
     * @see org.codelibs.elasticsearch.client.Requests#upgradeRequest(String...)
     */
     ...
     * @return A result future
     * @see org.codelibs.elasticsearch.client.Requests#putMappingRequest(String...)
     */
     ...
     * @see #getSettings(org.codelibs.elasticsearch.action.admin.indices.settings.get.GetSettingsRequest)
     */
