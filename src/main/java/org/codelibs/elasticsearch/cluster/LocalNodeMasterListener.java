...
public interface LocalNodeMasterListener {
     ...
     * the work done is the callbacks above is inexpensive, this value may be {@link org.codelibs.elasticsearch.threadpool.ThreadPool.Names#SAME SAME}
     ...
     * prefer to execute them on a separate more appropriate executor (eg. {@link org.codelibs.elasticsearch.threadpool.ThreadPool.Names#GENERIC GENERIC}
     * or {@link org.codelibs.elasticsearch.threadpool.ThreadPool.Names#MANAGEMENT MANAGEMENT}).
     *
