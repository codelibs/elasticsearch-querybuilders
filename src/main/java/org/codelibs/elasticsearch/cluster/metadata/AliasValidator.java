...
import org.codelibs.elasticsearch.indices.InvalidAliasNameException;
...
public class AliasValidator extends AbstractComponent {
    ...
    /**
     * Allows to validate an {@link org.codelibs.elasticsearch.action.admin.indices.alias.Alias} and make sure
    ...
    /**
     * Allows to validate an {@link org.codelibs.elasticsearch.cluster.metadata.AliasMetaData} and make sure
     * it's valid before it gets added to the index metadata. Doesn't validate the alias filter.
     * @throws IllegalArgumentException if the alias is not valid
     */
     ...
     * the alias filter via {@link org.codelibs.elasticsearch.common.xcontent.XContentParser},
     ...
     * provided {@link org.codelibs.elasticsearch.index.query.QueryShardContext}
