...
import org.codelibs.elasticsearch.cluster.DiffableUtils;
...
import org.codelibs.elasticsearch.cluster.node.DiscoveryNodeFilters;
import org.codelibs.elasticsearch.cluster.routing.allocation.IndexMetaDataUpdater;
import org.codelibs.elasticsearch.common.Nullable;
import org.codelibs.elasticsearch.common.bytes.BytesArray;
import org.codelibs.elasticsearch.common.collect.ImmutableOpenIntMap;
import org.codelibs.elasticsearch.common.collect.ImmutableOpenMap;
import org.codelibs.elasticsearch.common.collect.MapBuilder;
...
import static org.codelibs.elasticsearch.cluster.node.DiscoveryNodeFilters.OpType.AND;
import static org.codelibs.elasticsearch.cluster.node.DiscoveryNodeFilters.OpType.OR;
import static org.codelibs.elasticsearch.common.settings.Settings.readSettingsFromStream;
import static org.codelibs.elasticsearch.common.settings.Settings.writeSettingsToStream;
...
public class IndexMetaData implements Diffable<IndexMetaData>, ToXContent {
    ...
    public interface Custom extends Diffable<Custom>, ToXContent {
        ...
        /**
         * Reads the {@link org.codelibs.elasticsearch.cluster.Diff} from StreamInput
         */
     ...
     * {@link #isIndexUsingShadowReplicas(org.codelibs.elasticsearch.common.settings.Settings)}.
     */
     ...
     * {@link org.codelibs.elasticsearch.cluster.routing.OperationRouting#generateShardId(IndexMetaData, String, String)} to route documents
     ...
     * {@link org.codelibs.elasticsearch.cluster.routing.OperationRouting#generateShardId(IndexMetaData, String, String)} to guarantee consistent
