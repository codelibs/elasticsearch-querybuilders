...
public class DeprecationLogger {
     ...
     * prefixes the logger name with "deprecation", if it starts with "org.codelibs.elasticsearch.",
     * it replaces "org.codelibs.elasticsearch" with "org.codelibs.elasticsearch.deprecation" to maintain
     * the "org.codelibs.elasticsearch" namespace.
     */
    public DeprecationLogger(Logger parentLogger) {
        String name = parentLogger.getName();
        if (name.startsWith("org.codelibs.elasticsearch")) {
            name = name.replace("org.codelibs.elasticsearch.", "org.codelibs.elasticsearch.deprecation.");
        } else {
