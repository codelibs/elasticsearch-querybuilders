...
package org.codelibs.elasticsearch.common.recycler;
...
public enum Recyclers {
    ...
    public static <T> Recycler<T> locked(final Recycler<T> recycler) {
        return new FilterRecycler<T>() {
            ...
            @Override
            public org.codelibs.elasticsearch.common.recycler.Recycler.V<T> obtain(int sizing) {
                synchronized (lock) {
                    return super.obtain(sizing);
                }
            }
            ...
            @Override
            public org.codelibs.elasticsearch.common.recycler.Recycler.V<T> obtain() {
                synchronized (lock) {
                    return super.obtain();
                }
            }
