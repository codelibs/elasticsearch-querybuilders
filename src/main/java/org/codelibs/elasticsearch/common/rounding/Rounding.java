...
public abstract class Rounding implements Streamable {
    ...
    /**
     * Given the rounded value (which was potentially generated by {#round(long)}, returns the next rounding value. For example, with
    ...
    static class TimeIntervalRounding extends Rounding {
         ...
         * {DateTimeZone#convertLocalToUTC(long, boolean)} for the
         * `strict` mode case, but instead of throwing an
         * {IllegalInstantException}, which is costly, we want to return a
