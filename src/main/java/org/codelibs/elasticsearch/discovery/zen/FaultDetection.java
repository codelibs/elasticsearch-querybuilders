...
import org.codelibs.elasticsearch.transport.TransportConnectionListener;
...
public abstract class FaultDetection extends AbstractComponent implements Closeable {
    ...
    /**
     * This method will be called when the {@link org.codelibs.elasticsearch.transport.TransportService} raised a node disconnected event
     */
