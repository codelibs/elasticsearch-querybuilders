...
public final class EngineConfig {
    ...
    /**
     * Creates a new {@link org.codelibs.elasticsearch.index.engine.EngineConfig}
     */
     ...
     * {@link org.codelibs.elasticsearch.threadpool.ThreadPool#estimatedTimeInMillis()} and to schedule
     * async force merge calls on the {@link org.codelibs.elasticsearch.threadpool.ThreadPool.Names#FORCE_MERGE} thread-pool
     */
    ...
    /**
     * Returns an {@link org.codelibs.elasticsearch.index.engine.Engine.Warmer} used to warm new searchers before they are used for searching.
     */
    ...
    /**
     * Returns the {@link org.codelibs.elasticsearch.index.store.Store} instance that provides access to the
    ...
    /**
     * Returns the {@link org.codelibs.elasticsearch.index.shard.TranslogRecoveryPerformer} for this engine. This class is used
