...
import org.codelibs.elasticsearch.common.util.concurrent.AsyncIOProcessor;
import org.codelibs.elasticsearch.index.Index;
import org.codelibs.elasticsearch.index.IndexModule;
...
import org.codelibs.elasticsearch.index.cache.IndexCache;
import org.codelibs.elasticsearch.index.cache.bitset.ShardBitsetFilterCache;
import org.codelibs.elasticsearch.index.cache.request.ShardRequestCache;
import org.codelibs.elasticsearch.index.codec.CodecService;
import org.codelibs.elasticsearch.index.engine.CommitStats;
import org.codelibs.elasticsearch.index.engine.Engine;
import org.codelibs.elasticsearch.index.engine.EngineClosedException;
import org.codelibs.elasticsearch.index.engine.EngineConfig;
import org.codelibs.elasticsearch.index.engine.EngineException;
import org.codelibs.elasticsearch.index.engine.EngineFactory;
import org.codelibs.elasticsearch.index.engine.InternalEngineFactory;
import org.codelibs.elasticsearch.index.engine.RefreshFailedEngineException;
import org.codelibs.elasticsearch.index.engine.Segment;
import org.codelibs.elasticsearch.index.engine.SegmentsStats;
import org.codelibs.elasticsearch.index.fielddata.FieldDataStats;
import org.codelibs.elasticsearch.index.fielddata.IndexFieldDataService;
import org.codelibs.elasticsearch.index.fielddata.ShardFieldData;
import org.codelibs.elasticsearch.index.flush.FlushStats;
import org.codelibs.elasticsearch.index.get.GetStats;
import org.codelibs.elasticsearch.index.get.ShardGetService;
import org.codelibs.elasticsearch.index.mapper.DocumentMapper;
import org.codelibs.elasticsearch.index.mapper.DocumentMapperForType;
...
import org.codelibs.elasticsearch.index.mapper.ParsedDocument;
import org.codelibs.elasticsearch.index.mapper.SourceToParse;
import org.codelibs.elasticsearch.index.mapper.Uid;
import org.codelibs.elasticsearch.index.merge.MergeStats;
import org.codelibs.elasticsearch.index.recovery.RecoveryStats;
import org.codelibs.elasticsearch.index.refresh.RefreshStats;
import org.codelibs.elasticsearch.index.search.stats.SearchStats;
import org.codelibs.elasticsearch.index.search.stats.ShardSearchStats;
import org.codelibs.elasticsearch.index.similarity.SimilarityService;
import org.codelibs.elasticsearch.index.store.Store;
import org.codelibs.elasticsearch.index.store.Store.MetadataSnapshot;
import org.codelibs.elasticsearch.index.store.StoreFileMetaData;
import org.codelibs.elasticsearch.index.store.StoreStats;
import org.codelibs.elasticsearch.index.translog.Translog;
import org.codelibs.elasticsearch.index.translog.TranslogConfig;
import org.codelibs.elasticsearch.index.translog.TranslogStats;
import org.codelibs.elasticsearch.index.warmer.ShardIndexWarmerService;
import org.codelibs.elasticsearch.index.warmer.WarmerStats;
...
import org.codelibs.elasticsearch.indices.recovery.RecoveryFailedException;
import org.codelibs.elasticsearch.indices.recovery.RecoveryState;
import org.codelibs.elasticsearch.repositories.RepositoriesService;
import org.codelibs.elasticsearch.repositories.Repository;
import org.codelibs.elasticsearch.search.suggest.completion.CompletionFieldStats;
...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    /**
     * Returns the primary term the index shard is on. See {@link org.codelibs.elasticsearch.cluster.metadata.IndexMetaData#primaryTerm(int)}
     */
