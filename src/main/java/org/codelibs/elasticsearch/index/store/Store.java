...
import org.codelibs.elasticsearch.common.lucene.store.ByteArrayIndexInput;
...
import org.codelibs.elasticsearch.common.util.SingleObjectCache;
...
public class Store extends AbstractIndexShardComponent implements Closeable, RefCounted {
     ...
     *
     * @see MetadataSnapshot#recoveryDiff(org.codelibs.elasticsearch.index.store.Store.MetadataSnapshot)
     */
    ...
    public interface OnClose extends Callback<ShardLock> {
        OnClose EMPTY = new OnClose() {
            /**
             * This method is called while the provided {@link org.codelibs.elasticsearch.env.ShardLock} is held.
