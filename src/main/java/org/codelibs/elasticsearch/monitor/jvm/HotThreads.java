...
public class HotThreads {
    ...
    private static boolean isIdleThread(ThreadInfo threadInfo) {
        ...
        for (StackTraceElement frame : threadInfo.getStackTrace()) {
            ...
            if (className.equals("org.codelibs.elasticsearch.threadpool.ThreadPool$EstimatedTimeThread") &&
                methodName.equals("run")) {
                return true;
            }
            if (className.equals("org.codelibs.elasticsearch.indices.ttl.IndicesTTLService$Notifier") &&
