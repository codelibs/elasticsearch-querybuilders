...
import org.codelibs.elasticsearch.discovery.zen.UnicastHostsProvider;
import org.codelibs.elasticsearch.discovery.zen.ZenPing;
...
public interface DiscoveryPlugin {
     ...
     * (see {@link org.codelibs.elasticsearch.discovery.DiscoveryModule#DISCOVERY_TYPE_SETTING}, and
     ...
     * (see {@link org.codelibs.elasticsearch.discovery.DiscoveryModule#DISCOVERY_HOSTS_PROVIDER_SETTING}), and
     * the value is a supplier to construct the host provider when it is selected for use.
     *
     * @param transportService Use to form the {@link org.codelibs.elasticsearch.common.transport.TransportAddress} portion
     *                         of a {@link org.codelibs.elasticsearch.cluster.node.DiscoveryNode}
