 ...
 * <ul>
 * <li>Master calls {@link #initializeSnapshot(SnapshotId, List, org.codelibs.elasticsearch.cluster.metadata.MetaData)}
...
public interface Repository extends LifecycleComponent {
     ...
     * See {@link org.codelibs.elasticsearch.plugins.RepositoryPlugin}.
     */
    interface Factory {
        /**
     ...
     * @param verificationToken value returned by {@link org.codelibs.elasticsearch.repositories.Repository#startVerification()}
     ...
     * <p>
     * The index commit point can be obtained by using {@link org.codelibs.elasticsearch.index.engine.Engine#acquireIndexCommit} method.
