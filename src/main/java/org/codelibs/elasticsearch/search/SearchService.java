...
import org.codelibs.elasticsearch.common.util.concurrent.ConcurrentMapLong;
...
import org.codelibs.elasticsearch.index.shard.SearchOperationListener;
...
import org.codelibs.elasticsearch.search.dfs.DfsPhase;
...
import org.codelibs.elasticsearch.search.fetch.QueryFetchSearchResult;
import org.codelibs.elasticsearch.search.fetch.ScrollQueryFetchSearchResult;
import org.codelibs.elasticsearch.search.fetch.ShardFetchRequest;
import org.codelibs.elasticsearch.search.fetch.subphase.DocValueFieldsContext;
import org.codelibs.elasticsearch.search.fetch.subphase.ScriptFieldsContext.ScriptField;
...
import org.codelibs.elasticsearch.search.internal.InternalScrollSearchRequest;
import org.codelibs.elasticsearch.search.internal.ScrollContext;
...
import org.codelibs.elasticsearch.search.query.QuerySearchRequest;
import org.codelibs.elasticsearch.search.query.QuerySearchResult;
import org.codelibs.elasticsearch.search.query.QuerySearchResultProvider;
import org.codelibs.elasticsearch.search.query.ScrollQuerySearchResult;
import org.codelibs.elasticsearch.search.rescore.RescoreBuilder;
import org.codelibs.elasticsearch.search.searchafter.SearchAfterBuilder;
...
import org.codelibs.elasticsearch.search.suggest.completion.CompletionSuggestion;
import org.codelibs.elasticsearch.threadpool.ThreadPool;
import org.codelibs.elasticsearch.threadpool.ThreadPool.Cancellable;
import org.codelibs.elasticsearch.threadpool.ThreadPool.Names;
...
import static org.codelibs.elasticsearch.common.unit.TimeValue.timeValueMinutes;
...
public class SearchService extends AbstractLifecycleComponent implements IndexEventListener {
    ...
    private void parseSource(DefaultSearchContext context, SearchSourceBuilder source) throws SearchContextException {
        ...
        if (source.scriptFields() != null) {
            for (org.codelibs.elasticsearch.search.builder.SearchSourceBuilder.ScriptField field : source.scriptFields()) {
