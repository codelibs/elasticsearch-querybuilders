...
import org.codelibs.elasticsearch.search.aggregations.bucket.terms.Terms.Bucket;
import org.codelibs.elasticsearch.search.aggregations.bucket.terms.Terms.Order;
...
class InternalOrder extends Terms.Order {
     ...
     * Order by the terms.
     */
    public static final InternalOrder TERM_ASC = new InternalOrder(TERM_ASC_ID, "_term", true, (o1, o2) -> o1.compareTerm(o2));
