...
public interface Terms extends MultiBucketsAggregation {
    ...
    static enum ValueType {
        ...
        STRING(org.codelibs.elasticsearch.search.aggregations.support.ValueType.STRING),
        LONG(org.codelibs.elasticsearch.search.aggregations.support.ValueType.LONG),
        DOUBLE(org.codelibs.elasticsearch.search.aggregations.support.ValueType.DOUBLE);

        final org.codelibs.elasticsearch.search.aggregations.support.ValueType scriptValueType;

        private ValueType(org.codelibs.elasticsearch.search.aggregations.support.ValueType scriptValueType) {
