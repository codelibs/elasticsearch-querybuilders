...
import org.codelibs.elasticsearch.search.aggregations.support.values.ScriptBytesValues;
import org.codelibs.elasticsearch.search.aggregations.support.values.ScriptDoubleValues;
import org.codelibs.elasticsearch.search.aggregations.support.values.ScriptLongValues;
...
public abstract class ValuesSource {
    ...
    public abstract static class Bytes extends ValuesSource {
        ...
        public Bits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            if (org.codelibs.elasticsearch.index.fielddata.FieldData.unwrapSingleton(bytes) != null) {
                return org.codelibs.elasticsearch.index.fielddata.FieldData.unwrapSingletonBits(bytes);
            } else {
                return org.codelibs.elasticsearch.index.fielddata.FieldData.docsWithValue(bytes, context.reader().maxDoc());
            }
        }
        ...
        public abstract static class WithOrdinals extends Bytes {
            ...
            public static final WithOrdinals EMPTY = new WithOrdinals() {
                ...
                public SortedBinaryDocValues bytesValues(LeafReaderContext context) throws IOException {
                    return org.codelibs.elasticsearch.index.fielddata.FieldData.emptySortedBinary(context.reader().maxDoc());
                }
    ...
    public abstract static class Numeric extends ValuesSource {
        ...
        public static final Numeric EMPTY = new Numeric() {
            ...
            public SortedNumericDoubleValues doubleValues(LeafReaderContext context) throws IOException {
                return org.codelibs.elasticsearch.index.fielddata.FieldData.emptySortedNumericDoubles(context.reader().maxDoc());
            }
        ...
        public Bits docsWithValue(LeafReaderContext context) throws IOException {
            if (isFloatingPoint()) {
                ...
                if (org.codelibs.elasticsearch.index.fielddata.FieldData.unwrapSingleton(values) != null) {
                    return org.codelibs.elasticsearch.index.fielddata.FieldData.unwrapSingletonBits(values);
                } else {
                    return org.codelibs.elasticsearch.index.fielddata.FieldData.docsWithValue(values, context.reader().maxDoc());
                }
            } else {
    ...
    public abstract static class GeoPoint extends ValuesSource {
        ...
        public static final GeoPoint EMPTY = new GeoPoint() {
            ...
            public MultiGeoPointValues geoPointValues(LeafReaderContext context) {
                return org.codelibs.elasticsearch.index.fielddata.FieldData.emptyMultiGeoPoints(context.reader().maxDoc());
            }
        ...
        public Bits docsWithValue(LeafReaderContext context) {
            ...
            if (org.codelibs.elasticsearch.index.fielddata.FieldData.unwrapSingleton(geoPoints) != null) {
                return org.codelibs.elasticsearch.index.fielddata.FieldData.unwrapSingletonBits(geoPoints);
            } else {
                return org.codelibs.elasticsearch.index.fielddata.FieldData.docsWithValue(geoPoints, context.reader().maxDoc());
            }
        }
