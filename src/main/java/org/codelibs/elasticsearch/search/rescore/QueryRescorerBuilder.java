...
import org.codelibs.elasticsearch.search.rescore.QueryRescorer.QueryRescoreContext;
...
public class QueryRescorerBuilder extends RescoreBuilder<QueryRescorerBuilder> {
    ...
    public QueryRescoreContext build(QueryShardContext context) throws IOException {
        org.codelibs.elasticsearch.search.rescore.QueryRescorer rescorer = new org.codelibs.elasticsearch.search.rescore.QueryRescorer();
