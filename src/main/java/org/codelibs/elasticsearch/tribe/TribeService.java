...
import org.codelibs.elasticsearch.common.hash.MurmurHash3;
 ...
 * <p>
 * The {@link #processSettings(org.codelibs.elasticsearch.common.settings.Settings)} method should be called before
 ...
 * write level master node operations will work ({@link org.codelibs.elasticsearch.discovery.MasterNotDiscoveredException}
...
public class TribeService extends AbstractLifecycleComponent {
    ...
    /**
     * Interface to allow merging {@link org.codelibs.elasticsearch.cluster.metadata.MetaData.Custom} in tribe node
